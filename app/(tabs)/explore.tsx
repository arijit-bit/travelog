    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <SafeAreaView style={styles.modalContainer}>
          ...
          {/* Only render MapView if we have path data */}
          {selectedTrip && selectedTrip.path.length > 0 ? (
            <>
              ...
              >
                ...
                <Marker
                  coordinate={selectedTrip.path[0]}
                  title="Start"
                  pinColor="green"
                />
                {selectedTrip.path.length > 1 && (
                  <Marker
                    coordinate={selectedTrip.path[selectedTrip.path.length - 1]}
                    title="End"
                    pinColor="red"
                  />
                )}
              ...
              <View style={styles.modalStats}>
                <View style={styles.modalStatItem}>
                  ...
                  <Text style={styles.modalStatValue}>
                    {(selectedTrip.distance / 1000).toFixed(2)} km
                  </Text>
                </View>
                <View style={styles.modalStatItem}>
                ...
                <View style={styles.modalStatItem}>
                  ...
                  <Text style={styles.modalStatValue}>
                    {(selectedTrip.averageSpeed * 3.6).toFixed(1)} km/h
                  </Text>
                </View>
              </View>
            </>
            ...
            <View style={styles.emptyState}>
              <Text style={styles.emptyStateTitle}>No GPS Data</Text>
              <Text style={styles.emptyStateText}>
                This trip doesn't have any location points to display on map.
              </Text>
            </View>
          )}
        </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  tripDate: { fontSize: 18, fontWeight: '600', color: '#333' },
  ...
  statValue: { fontSize: 16, fontWeight: '600', color: '#007AFF' },
  tripFooter: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  pathPoints: { fontSize: 12, color: '#999' },
  viewMapText: { fontSize: 12, color: '#007AFF', fontWeight: '500' },
  ...
  modalStatLabel: { fontSize: 14, color: '#666', marginBottom: 4 },
  modalStatValue: { fontSize: 18, fontWeight: '600', color: '#007AFF' },
});
